    ...
    public class MenuAccessibility : MonoBehaviour
    {
            ...
            try
            {
                ...
                if (currentLevel >= 0 && (covenantUI != _lastCovenantUI || currentLevel != _lastCovenantLevel))
                {
                    if (_lastCovenantUI != null && _lastCovenantLevel >= 0 && _lastCovenantLevel != currentLevel)
                    {
                        ...
                        string text = GetCovenantSelectorText(_lastSelectedObject);
        ...
        private string GetUnitTargetInfo(GameObject targetElement)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(text))
                {
                    return $"Target: {BattleAccessibility.StripRichTextTags(text)}";
                }

                // Last fallback: use element name
                string cleanName = CleanGameObjectName(targetElement.name);
        ...
        private string GetUnitDescription(object characterState)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(name))
                {
                    if (attack >= 0 && hp >= 0)
                    {
                        return $"{BattleAccessibility.StripRichTextTags(name)}: {attack} attack, {hp} health";
                    }
        ...
        private string GetTextFromGameObject(GameObject go)
        {
            ...
            text = GetCompendiumRelicText(go);
            if (!string.IsNullOrEmpty(text))
            {
                return text;
            }
            ...
            text = GetUpgradeLevelNodeText(go);
            if (!string.IsNullOrEmpty(text))
            {
                return text;
            }
            ...
            text = GetSubclanVictoryItemText(go);
            if (!string.IsNullOrEmpty(text))
            {
                return text;
            }
            ...
            text = GetCompendiumSortButtonText(go);
            if (!string.IsNullOrEmpty(text))
            {
                return text;
            }
            ...
            try
            {
                ...
                if (getNameMethod != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(name))
                    {
                        ...
                        {
                            desc = ResolveRelicEffectPlaceholders(desc, data, dataType);
                        ...
                        if (isRelicType)
                        {
                            parts.Add($"Artifact: {BattleAccessibility.StripRichTextTags(name)}");
                        }
                        else
                        {
                            parts.Add(BattleAccessibility.StripRichTextTags(name));
                        ...
                        if (!string.IsNullOrEmpty(desc))
                        {
                            ...
                            {
                                var keywords = new List<string>();
                                ExtractKeywordsFromDescription(desc, keywords);
                                if (keywords.Count > 0)
                                {
        ...
        /// </summary>
        private string ExtractStatusEffectUpgradeInfo(object statusEffectUpgrade)
        {
        ...
        /// </summary>
        private string ExtractTriggerUpgradeInfo(object triggerUpgrade)
        {
        ...
        /// </summary>
        private string FormatStatusEffectName(string statusId)
        {
                ...
                if (buyButton != null)
                {
                    ...
                    if (altTextField != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(altText))
                        {
                            ...
                            string cleanText = BattleAccessibility.StripRichTextTags(altText);
                    ...
                    if (labelField != null)
                    {
                        ...
                        if (label != null)
                        {
                            ...
                            if (textProp != null)
                            {
                                ...
                                if (!string.IsNullOrEmpty(labelText))
                                {
                                    string cleanLabel = BattleAccessibility.StripRichTextTags(labelText);
        ...
        /// </summary>
        private string ResolveCardEffectPlaceholders(string text, object cardState, object cardData)
        {
        ...
        /// </summary>
        private string AddContextToEffectNumbers(string text)
        {
            if (string.IsNullOrEmpty(text))
                return text;
        ...
        /// </summary>
        private string GetCompendiumRelicText(GameObject go)
        {
            try
            {
                        ...
                        if (count > 0)
                        {
                            ...
                            if (tooltip != null)
                            {
                                ...
                                if (!string.IsNullOrEmpty(title))
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(body))
                                    {
                                        string cleanBody = BattleAccessibility.StripRichTextTags(body);
                                        cleanBody = CleanSpriteTagsForSpeech(cleanBody);
                                        sb.Append(". ");
                                        sb.Append(cleanBody);
                                    }
        ...
        /// </summary>
        private string GetUpgradeLevelNodeText(GameObject go)
        {
            try
            {
                ...
                var sb = new StringBuilder();
                if (!string.IsNullOrEmpty(treeTitle) && !IsGarbageText(treeTitle))
                {
                    sb.Append(treeTitle);
                    sb.Append(", ");
                }
        ...
        /// </summary>
        private string GetPlayerStatRowText(GameObject go)
        {
            try
            {
        ...
        /// </summary>
        private string GetClanChecklistText(GameObject go)
        {
            try
            {
        ...
        /// </summary>
        private string GetSubclanVictoryItemText(GameObject go)
        {
            try
            {
                            ...
                            if (tooltipsList != null)
                            {
                                ...
                                if (count > 0)
                                {
                                    ...
                                    if (tooltip != null)
                                    {
                                        ...
                                        {
                                            if (sb.Length > 0) sb.Append(". ");
                                            sb.Append(BattleAccessibility.StripRichTextTags(body));
                                        }
        ...
        /// </summary>
        private string GetRunStatRowText(GameObject go)
        {
            try
            {
        ...
        /// </summary>
        private string GetCompendiumSortButtonText(GameObject go)
        {
            try
            {
                ...
                if (filterOptionButton != null)
                {
                    ...
                    if (labelField != null)
                    {
                        ...
                        if (label != null)
                        {
                            ...
                            {
                                string labelText = textProp.GetValue(label) as string;
                                if (!string.IsNullOrEmpty(labelText) && labelText != "?" && !IsGarbageText(labelText))
                                {
                ...
                if (goName.ToLower().Contains("button"))
                {
                    ...
                    foreach (var component in go.GetComponentsInChildren<Component>())
                    {
                        ...
                        if (typeName == "TextMeshProUGUI" || typeName == "ExtendedTextMeshProUGUI" || typeName == "TextMeshPro")
                        {
                            ...
                            {
                                string text = textProp.GetValue(component) as string;
                                if (!string.IsNullOrEmpty(text) && text.Trim().Length > 0 && !IsGarbageText(text))
                                {
                                    return text.Trim();
                                }
                            }
                    ...
                    string cleanName = CleanGameObjectName(goName);
        ...
        private string GetChampionChoiceText(GameObject go)
        {
            try
            {
                ...
                // Check if this specific button is actually locked by checking lockedTooltipProvider.enabled
                // (The game sets lockedTooltipProvider.enabled = locked in ChampionChoiceButton.SetState)
                bool isButtonLocked = false;
                var tooltipProviderField = buttonType.GetField("lockedTooltipProvider", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
                if (tooltipProviderField != null)
                {
                    var provider = tooltipProviderField.GetValue(championButton);
                    if (provider != null)
                    {
                        var enabledProp = provider.GetType().GetProperty("enabled");
                        if (enabledProp != null)
                        {
                            isButtonLocked = (bool)enabledProp.GetValue(provider);
                        }
                    }
                }
                ...
                // If we have champion data, try to get the name and additional info
                ...
                // Fallback: Try to get champion info directly from the button object's children
                var textsInChildren = GetAllTextFromChildren(go);
                if (textsInChildren != null && textsInChildren.Count > 0)
                {
                    // Filter out generic labels
                    var meaningfulTexts = textsInChildren.Where(t =>
                        !string.IsNullOrWhiteSpace(t) &&
                        t.Length > 3 &&
                        !t.ToLower().Contains("champion option") &&
                        !t.ToLower().Contains("unlocks at")
                    ).ToList();

                    if (meaningfulTexts.Count > 0)
                    {
                        string result = "Champion: " + string.Join(". ", meaningfulTexts);
                        if (isLocked || isButtonLocked)
                            result += " (Locked)";
                        return result;
                    }
                ...
                // Check if locked via per-button lock state
                if (isButtonLocked)
                {
        ...
        public void ReadTrainStatsPanel()
        {
            try
            {
                ...
                if (statsPanel != null)
                {
                    ...
                    var texts = GetAllTextFromChildren(statsPanel);
                    if (texts != null && texts.Count > 0)
                    {
        ...
        public void ReadAllScreenText()
        {
            try
            {
                ...
                foreach (var textComp in allTextComponents)
                {
                    ...
                    {
                        string cleanText = BattleAccessibility.StripRichTextTags(textComp.text.Trim());
                        if (!string.IsNullOrEmpty(cleanText) && !collectedTexts.Contains(cleanText) && !IsGarbageText(cleanText))
                        {
        ...
        private void FindAllTMPText(HashSet<string> collectedTexts, StringBuilder sb)
        {
            try
            {
                ...
                foreach (var tmp in allTMP)
                {
                    ...
                    if (!string.IsNullOrEmpty(text))
                    {
                        string cleanText = BattleAccessibility.StripRichTextTags(text.Trim());
                        if (!string.IsNullOrEmpty(cleanText) && !collectedTexts.Contains(cleanText) && !IsGarbageText(cleanText))
                        {
                            collectedTexts.Add(cleanText);
                            sb.AppendLine(cleanText);
        ...
        private void CollectAllTextUnique(Transform transform, HashSet<string> collected, StringBuilder sb)
        {
            ...
            if (uiText != null && !string.IsNullOrEmpty(uiText.text))
            {
                string cleaned = BattleAccessibility.StripRichTextTags(uiText.text.Trim());
                if (!string.IsNullOrEmpty(cleaned) && !collected.Contains(cleaned) && !IsGarbageText(cleaned))
                {
            ...
            if (!string.IsNullOrEmpty(tmpText))
            {
                string cleaned = BattleAccessibility.StripRichTextTags(tmpText.Trim());
                if (!string.IsNullOrEmpty(cleaned) && !collected.Contains(cleaned) && !IsGarbageText(cleaned))
                {
                    collected.Add(cleaned);
                    sb.AppendLine(cleaned);
